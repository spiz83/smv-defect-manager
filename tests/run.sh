...
if [ "$QUICK" != "quick" ]; then
  echo "GATE 3 — behaviour (16 suites, real Chromium)"
  for f in adddefects combo deep fixes hdr loc pdfname pvgallery pvphoto recur rows shop sync tradefilter tradepdf tradereassign; do
